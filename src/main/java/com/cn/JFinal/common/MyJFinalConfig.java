package com.cn.JFinal.common;

import com.cn.JFinal.common.model._MappingKit;
...
public class MyJFinalConfig extends JFinalConfig {
	...
	public void configPlugin(Plugins me) {
		// 配置 druid 数据库连接池插件
		DruidPlugin druidPlugin = new DruidPlugin(PropKit.get("jdbcUrl").trim(), PropKit.get("user").trim(),
