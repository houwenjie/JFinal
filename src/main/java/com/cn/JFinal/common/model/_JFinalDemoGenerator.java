package com.cn.JFinal.common.model;

import javax.sql.DataSource;
import com.cn.JFinal.common.MyJFinalConfig;
...
public class _JFinalDemoGenerator {
	...
	public static void main(String[] args) {
		// base model 所使用的包名
		String baseModelPackageName = "com.cn.JFinal.common.model.base";
		// base model 文件保存路径
		String baseModelOutputDir = PathKit.getWebRootPath() + "/src/main/java/com/cn/JFinal/common/model/base";

		// model 所使用的包名 (MappingKit 默认使用的包名)
		String modelPackageName = "com.cn.JFinal.common.model";
